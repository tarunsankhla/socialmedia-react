            ...
            <div className='beside-navbar-container'>
                ...
                <div className='beside-user-data-container'>
                    ...
                    userFollowArray.map(user => (
                        <div className='user-data-beside-section'>
                            <div className='user-data-beside-section-name'>
                                ...
                                <span className='fn-wg-700'>{user.name}</span>
                            </div>
                            <span>  {userData.followers.some(i => i.userId === user.userId) ?
                                <span className='user-data-beside-section-name fn-wg-700 hover gray-txt lg-txt' >
                                    following
                                </span>
                                : <span className='user-data-beside-section-name fn-wg-700  hover red-txt lg-txt'
                                >
                                    follow <IconPlus />
                                </span>}</span>
                        </div>
